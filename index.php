      ...
      <div class="col-6">
          ...
          <div class="form-group">
            ...
            <select name="role" id="role" class="form-control selBox" required="required">
                ...
                <option value="Marksman/Goldlane">Marksman/Gold Lane</option>
                <option value="Mage/Explane">Mage/Exp Lane</option>
                <option value="Tank/Assasin">Tank/Assasin</option>
            </select>
          </div>
          ...
          <div class="form-group">
            ...
            <select name="item" id="item" class="form-control selBox" required="required">
                      ...
                      <option value="Belum_Mahir">Belum Mahir</option>
          ...
          <div class="form-group">
            ...
            <select name="micro" id="micro" class="form-control selBox" required="required">
...
<script>
  ...
  {
    var umur = $("#umur").val();
    var tinggi_badan = $("#role").val();
    var berat_badan = $("#item").val();
    var status_kesehatan = $("#kesehatan").val();
    var pendidikan = $("#micro").val();

    //validasi
    var um = document.getElementById("umur");
    var tb = document.getElementById("role");
    var bb = document.getElementById("item");
    var sk = document.getElementById("kesehatan");
    var pp = document.getElementById("micro");
    ...
    //batas validasi
      ...
      $.ajax({
        ...
        type : 'POST',
        dataType : 'html',
        data : {umur : umur , role : tinggi_badan , item : berat_badan , kesehatan : status_kesehatan , micro : pendidikan},
